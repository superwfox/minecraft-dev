...
const REASON_MESSAGES: Record<LearningReasonCode, string> = {
    ...
    planner_authorization_expired: "已选方案或技术缺口已经变化，已停止旧的联网查证任务",
    fix_authorization_expired: "对应构建诊断已经变化，已停止本次兜底学习",
    tool_authorization_expired: "模型学习请求已经变化，已停止旧的联网查证任务",
    tool_request_invalid: "模型提交的学习请求未通过安全校验，已按现有知识继续",
    revision_conflict: "学习任务已由另一请求推进，正在对账最新状态",
    lease_conflict: "学习任务正在由另一请求处理，正在对账最新状态",
    storage_unavailable: "学习存储暂不可用，已按现有知识继续",
    job_deadline: "连续 5 分钟没有可确认的联网查证进展，已按现有知识继续",
